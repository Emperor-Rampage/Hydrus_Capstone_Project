Shader "Custom/MonsterShader" {
	Properties {
		...
		_HurtValue("Hurt Percentage", Float) = 0.0
		_Color ("Color", Color) = (1,1,1,1)
		_MainTex ("Albedo (RGB)", 2D) = "white" {}
		_Glossiness ("Smoothness", Range(0,1)) = 0.5
		_GloosTex("Smoothness Texture", 2D) = "none"{}
		_Metallic ("Metallic", Range(0,1)) = 0.0
		_MetalTex("Metallic Map", 2D) = "none" {}
		_EmissiveTex("Emmision", 2D) = "none" {}
		_DissolveScale("Dissolve Scale", Range(0,1)) = 0.0
		_DissolveTex("Dissolve Texture", 2D) = "none"{}
